    cHidGuid: TGUID = '{25dbce51-6c8f-4a72-8a6d-b54c2b4fc835}';
  
    Battery Devices
    Class = Battery
    ...
    This class includes CD-ROM drives, including SCSI CD-ROM drives. By default, the systems CD-ROM class installer also installs a system-supplied CD audio driver and CD-ROM changer driver as Plug and Play filters.
